...
public class SlotSharpener extends Slot {
	...
	public SlotSharpener(EntityPlayer par1EntityPlayer,
	...
	protected void onCrafting(ItemStack par1ItemStack) {
		...
		if (!this.thePlayer.worldObj.isRemote) {
			...
			float var3 = SharpenerRecipes.instance().getExperience(
		...
		TCRegistry.onItemSharpened(thePlayer, par1ItemStack);
	}
}
