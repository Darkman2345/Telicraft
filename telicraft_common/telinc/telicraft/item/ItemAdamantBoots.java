...
public class ItemAdamantBoots extends ItemArmor implements IArmorTextureProvider {

	public ItemAdamantBoots(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4) {
