...
public class AchievementReferences {
	/** The name of the "Blue Stuff?" achievement. */
	public static final String ACH_BLUE_STUFF_NAME = "Blue Stuff?";
	
	/** The description of the "Blue Stuff?" achievement. */
	public static final String ACH_BLUE_STUFF_DESC = "Smelt Adamant Ore.";
	
	/** The name of the "King Arthur" achievement. */
	...
	/** The name of the "Not for kids!" achievement. */
	...
	/** The name of the "You mad, bro?" achievement. */
	...
	/** The name of the "Griefer's gonna grief" achievement. */
