...
public class ContainerAdamantFurnace extends Container {
	private TileEntityAdamantFurnace furnace;
	private int lastCookTime = 0;
	private int lastBurnTime = 0;
	private int lastItemBurnTime = 0;

	public ContainerAdamantFurnace(InventoryPlayer par1InventoryPlayer,
			TileEntityAdamantFurnace par2TileEntityFurnace) {
		...
		this.addSlotToContainer(new Slot(par2TileEntityFurnace, 3, 78, 17));
		this.addSlotToContainer(new SlotAdamantFurnace(
				par1InventoryPlayer.player, par2TileEntityFurnace, 2, 116, 35));
		int var3;
	...
	public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2) {
		...
		if (var4 != null && var4.getHasStack()) {
			...
			if (par2 == 2) {
				...
				} else if (TileEntityAdamantFurnace.isItemFuel(var5)) {
