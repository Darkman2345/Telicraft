...
public class BlockAdamantFurnace extends BlockContainer {
	...
	public TileEntity createNewTileEntity(World par1World) {
		return new TileEntityAdamantFurnace();
	}
	...
	private void dropItems(World par1World, int par2, int par3, int par4) {
		if (!keepFurnaceInventory) {
			TileEntityAdamantFurnace var7 = (TileEntityAdamantFurnace) par1World
	...
	private void setHeat(World world, int x, int y, int z, boolean value){
		TileEntityAdamantFurnace tile_entity = (TileEntityAdamantFurnace) world.getBlockTileEntity(x, y, z);
