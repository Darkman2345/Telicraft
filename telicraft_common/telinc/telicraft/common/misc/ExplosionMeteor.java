package telinc.telicraft.common.misc;
	...
	public void doExplosionA() {
		...
		List var9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(
				...
				AxisAlignedBB.getAABBPool().addOrModifyAABBInPool(
						...
						(double) var4, (double) var28, (double) var29));
		...
		for (int var11 = 0; var11 < var9.size(); ++var11) {
			...
			if (var13 <= 1.0D) {
				...
				if (var33 != 0.0D) {
					...
					var17 /= var33;
					var19 /= var33;
					double var32 = (double) this.worldObj.getBlockDensity(
							var30, var31.boundingBox);
		...
		if (this.isSmoking) {
			...
			while (var2.hasNext()) {
				...
				if (par1) {
					...
					double var20 = (double) MathHelper.sqrt_double(var14
							* var14 + var16 * var16 + var18 * var18);
					var14 /= var20;
					var16 /= var20;
					var18 /= var20;
				...
				if (var7 > 0) {
					...
					if (var25.func_85103_a(this)) {
						...
						var25.dropBlockAsItemWithChance(this.worldObj, var4,
								var5, var6, this.worldObj.getBlockMetadata(
										var4, var5, var6), 0.1F, 0);							
						}
					}
