 ...
 * 
 * @see telinc.telicraft.api.TCRegistry#registerSharpenerHandler(ISharpenerHandler handler)
 */
public interface ISharpenerHandler {
     ...
     * @param par2ItemStack The item that's taken out. This would be the perfect
     * time to check if you want to give an achievement.
     */
