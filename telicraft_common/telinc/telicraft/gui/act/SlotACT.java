...
public class SlotACT extends Slot {
	...
	public SlotACT(EntityPlayer par1EntityPlayer, IInventory par2IInventory,
	...
	protected void onCrafting(ItemStack par1ItemStack) {
		...
		} else if (par1ItemStack.itemID == TelicraftMain.meteorBomb.blockID){
			this.thePlayer.addStat(TelicraftMain.griefer, 1);
		}
	}
