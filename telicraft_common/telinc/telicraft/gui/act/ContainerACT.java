package telinc.telicraft.gui.act;
...
public class ContainerACT extends Container {
	...
	public ContainerACT(InventoryPlayer par1InventoryPlayer, World par2World,
			int par3, int par4, int par5) {
		this.worldObj = par2World;
		this.posX = par3;
		this.posY = par4;
		this.posZ = par5;
		this.addSlotToContainer(new SlotACT(par1InventoryPlayer.player,
	...
	public boolean canInteractWith(EntityPlayer par1EntityPlayer) {
		return this.worldObj.getBlockId(this.posX, this.posY, this.posZ) != TelicraftMain.act.blockID ? false
