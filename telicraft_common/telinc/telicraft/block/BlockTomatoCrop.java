...
public class BlockTomatoCrop extends BlockFlower implements IPlantable {

	private int metadata;

	public BlockTomatoCrop(int par1, int par2, Material par3) {
	...
	public int getBlockTextureFromSideAndMetadata(int par1, int par2) {
		...
		switch (par2) {
		case 0:
			return TelicraftMain.tomatoCrop.blockIndexInTexture;
		case 1:
			return TelicraftMain.tomatoCrop.blockIndexInTexture + 1;
		case 2:
			return TelicraftMain.tomatoCrop.blockIndexInTexture + 2;
		case 3:
			return TelicraftMain.tomatoCrop.blockIndexInTexture + 3;
		case 4:
			return TelicraftMain.tomatoCrop.blockIndexInTexture + 4;
		case 5:
			return TelicraftMain.tomatoCrop.blockIndexInTexture + 5;
		case 6:
			return TelicraftMain.tomatoCrop.blockIndexInTexture + 6;
		case 7:
			return TelicraftMain.tomatoCrop.blockIndexInTexture + 7;
		default:
	...
	public int idDropped(int par1, Random par2Random, int par3) {
		return TelicraftMain.tomato.shiftedIndex;
	}
	...
	public int getPlantID(World world, int x, int y, int z) {
		return TelicraftMain.tomatoCrop.blockID;
	}
