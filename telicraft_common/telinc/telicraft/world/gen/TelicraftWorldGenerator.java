...
public class TelicraftWorldGenerator implements IWorldGenerator {
    ...
    private void generateEnd(World world, Random rand, int chunkX, int chunkZ) {
        for(int i = 0; i < 35; i++){
            ...
            (new WorldGenEnd(TelicraftMain.darkEndStone.blockID, 0, 15)).generate(world, rand, desXcoord, desYcoord, desZcoord);
        }
    }
    ...
    public void generateNether(World world, Random rand, int chunkX, int chunkZ) {
        for(int i = 0; i < 30; i++){
            ...
            (new WorldGenNether(TelicraftMain.crackedNetherrack.blockID, 0, 10)).generate(world, rand, nrXcoord, nrYcoord, nrZcoord);
        }
    }
    ...
    public void generateSurface(World world, Random rand, int chunkX, int chunkZ) {
        for(int i = 0; i < 5; i++){
            ...
            int adamantYcoord = rand.nextInt(40);
            int adamantZcoord = chunkZ + rand.nextInt(16);

            (new WorldGenMinable(TelicraftMain.adamantOre.blockID, 4)).generate(world, rand, adamantXcoord, adamantYcoord, adamantZcoord);
        }
        ...
        for(int j = 0; j < 2; j++){
            ...
            (new WorldGenFlowers(TelicraftMain.squill.blockID)).generate(world, rand, squillXcoord, squillYcoord, squillZcoord);
        }
