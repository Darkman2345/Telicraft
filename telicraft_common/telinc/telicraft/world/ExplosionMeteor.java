...
public class ExplosionMeteor extends Explosion {
    ...
    public ExplosionMeteor(World par1World, Entity par2Entity, double par3, double par5, double par7, float par9) {
        ...
        for(int var11 = 0; var11 < var9.size(); ++var11){
            ...
            if(var13 <= 1.0D){
                ...
                if(var33 != 0.0D){
                    ...
                    var31.attackEntityFrom(TelicraftDamageSources.meteorBomb, (int)((var34 * var34 + var34) / 2.0D * 8.0D * (double)this.explosionSize + 1.0D));
    ...
    public void doExplosionB(boolean par1) {
        this.worldObj.playSoundEffect(this.explosionX, this.explosionY, this.explosionZ, "telicraft.meteorBomb", 4.0F, (1.0F + (this.worldObj.rand.nextFloat() - this.worldObj.rand.nextFloat()) * 0.2F) * 0.7F);
                ...
                if(var7 > 0){
                    ...
                    if(var25.canDropFromExplosion(this)){
                        if(this.explosionRNG.nextInt(5) <= 3){
                            var25.dropBlockAsItemWithChance(this.worldObj, var4, var5, var6, this.worldObj.getBlockMetadata(var4, var5, var6), 0.1F, 0);
                        }
                    }
                    ...
                    if(this.worldObj.setBlockAndMetadataWithUpdate(var4, var5, var6, 0, 0, this.worldObj.isRemote)){
                        ...
                        this.worldObj.markBlockForUpdate(var4, var5, var6);
                    }
        ...
        while(var2.hasNext()){
            ...
            if(var7 == 0 && Block.opaqueCubeLookup[var24] && this.explosionRNG.nextInt(45) == 0){
                this.worldObj.setBlockWithNotify(var4, var5, var6, TelicraftMain.meteorBlock.blockID);
            }
        }
    }
