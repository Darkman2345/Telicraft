...
public class ExplosionMeteor extends Explosion {
    ...
    public ExplosionMeteor(World par1World, Entity par2Entity, double par3,
    ...
    public void doExplosionA() {
        ...
        for(var3 = 0; var3 < this.field_77289_h; ++var3){
            for(var4 = 0; var4 < this.field_77289_h; ++var4){
                for(var5 = 0; var5 < this.field_77289_h; ++var5){
                    if(var3 == 0 || var3 == this.field_77289_h - 1 || var4 == 0
                            || var4 == this.field_77289_h - 1 || var5 == 0
                            || var5 == this.field_77289_h - 1){
                        double var6 = (double)((float)var3
                                / ((float)this.field_77289_h - 1.0F) * 2.0F - 1.0F);
                        double var8 = (double)((float)var4
                                / ((float)this.field_77289_h - 1.0F) * 2.0F - 1.0F);
                        double var10 = (double)((float)var5
                                / ((float)this.field_77289_h - 1.0F) * 2.0F - 1.0F);
                        ...
                        for(float var21 = 0.3F; var14 > 0.0F; var14 -= var21 * 0.75F){
                            ...
                            int var25 = this.worldObj.getBlockId(var22, var23,
                                    var24);

                            if(var25 > 0){
                                Block var26 = Block.blocksList[var25];
                                float var27 = this.exploder != null ? this.exploder
                                        .func_82146_a(this, var26, var22,
                                                var23, var24) : var26
        ...
        var3 = MathHelper.floor_double(this.explosionX
                - (double)this.explosionSize - 1.0D);
        var4 = MathHelper.floor_double(this.explosionX
                + (double)this.explosionSize + 1.0D);
        var5 = MathHelper.floor_double(this.explosionY
                - (double)this.explosionSize - 1.0D);
        int var28 = MathHelper.floor_double(this.explosionY
                + (double)this.explosionSize + 1.0D);
        int var7 = MathHelper.floor_double(this.explosionZ
                - (double)this.explosionSize - 1.0D);
        int var29 = MathHelper.floor_double(this.explosionZ
                + (double)this.explosionSize + 1.0D);
        List var9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(
                this.exploder,
                AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)var3,
                        (double)var5, (double)var7, (double)var4,
                        (double)var28, (double)var29));
        Vec3 var30 = this.worldObj.getWorldVec3Pool().getVecFromPool(
                this.explosionX, this.explosionY, this.explosionZ);

        for(int var11 = 0; var11 < var9.size(); ++var11){
            Entity var31 = (Entity)var9.get(var11);
            double var13 = var31.getDistance(this.explosionX, this.explosionY,
                    this.explosionZ) / (double)this.explosionSize;

            if(var13 <= 1.0D){
                var15 = var31.posX - this.explosionX;
                var17 = var31.posY + (double)var31.getEyeHeight()
                        - this.explosionY;
                var19 = var31.posZ - this.explosionZ;
                double var33 = (double)MathHelper.sqrt_double(var15 * var15
                ...
                if(var33 != 0.0D){
                    ...
                    var17 /= var33;
                    var19 /= var33;
                    double var32 = (double)this.worldObj.getBlockDensity(var30,
                            var31.boundingBox);
                    double var34 = (1.0D - var13) * var32;
                    var31.attackEntityFrom(TelicraftDamageSources.meteorBomb,
                            (int)((var34 * var34 + var34) / 2.0D * 8.0D
                                    * (double)this.explosionSize + 1.0D));
                    ...
                    if(var31 instanceof EntityPlayer){
                        this.field_77288_k.put(
                                ...
                                this.worldObj.getWorldVec3Pool()
                                        .getVecFromPool(var15 * var34,
                                                var17 * var34, var19 * var34));
                    }
                }
            }
        }
    ...
    public void doExplosionB(boolean par1) {
        ...
        if(this.isSmoking){
            ...
            while(var2.hasNext()){
                ...
                if(par1){
                    double var8 = (double)((float)var4 + this.worldObj.rand
                            .nextFloat());
                    double var10 = (double)((float)var5 + this.worldObj.rand
                            .nextFloat());
                    double var12 = (double)((float)var6 + this.worldObj.rand
                            .nextFloat());
                    double var14 = var8 - this.explosionX;
                    double var16 = var10 - this.explosionY;
                    double var18 = var12 - this.explosionZ;
                    double var20 = (double)MathHelper.sqrt_double(var14 * var14
                            + var16 * var16 + var18 * var18);
                    var14 /= var20;
                    var16 /= var20;
                    var18 /= var20;
                    double var22 = 0.5D / (var20 / (double)this.explosionSize + 0.1D);
                    var22 *= (double)(this.worldObj.rand.nextFloat()
                    ...
                    this.worldObj.spawnParticle("explode",
                            ...
                            (var12 + this.explosionZ * 1.0D) / 2.0D, var14,
                            var16, var18);
                    this.worldObj.spawnParticle("smoke", var8, var10, var12,
                            var14, var16, var18);
                }
                ...
                if(var7 > 0){
                    ...
                    if(var25.canDropFromExplosion(this)){
                        if(this.explosionRNG.nextInt(5) <= 3){
                            var25.dropBlockAsItemWithChance(this.worldObj,
                                    var4, var5, var6,
                                    this.worldObj.getBlockMetadata(var4, var5,
                                            var6), 0.1F, 0);
                        }
                    }

                    if(this.worldObj.setBlockAndMetadataWithUpdate(var4, var5,
                            var6, 0, 0, this.worldObj.isRemote)){
                        this.worldObj.notifyBlocksOfNeighborChange(var4, var5,
                                var6, 0);
                    }

                    var25.onBlockDestroyedByExplosion(this.worldObj, var4,
                            var5, var6);
                }
            }
        }
        ...
        if(this.isFlaming){
            ...
            while(var2.hasNext()){
                ...
                if(var7 == 0 && Block.opaqueCubeLookup[var24]
                        && this.explosionRNG.nextInt(45) == 0){
                    this.worldObj.setBlockWithNotify(var4, var5, var6,
                            TelicraftMain.meteorBlock.blockID);
                }
            }
        }
    }
