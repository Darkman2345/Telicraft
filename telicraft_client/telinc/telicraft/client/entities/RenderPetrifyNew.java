...
public class RenderPetrifyNew extends Render
{
     ...
     */
    public void renderPetrify(EntityPetrify par1Entity, double par2, double par4, double par6, float par8, float par9)
    {
        GL11.glPushMatrix();
        ...
        float var12 = 0.75F;	// 0.75F
        GL11.glScalef(var12, var12, var12);
        GL11.glScalef(1.0F / var12, 1.0F / var12, 1.0F / var12);
        this.loadTexture(TextureReferences.POTION_PETRIFY_NEW);
        GL11.glScalef(-1.0F, -1.0F, 1.0F);
        this.modelPetrify.render(par1Entity, 0.0F, 0.0F, -0.1F, 0.0F, 0.0F, 0.0625F);
        GL11.glPopMatrix();
    }
    ...
    {
        this.renderPetrify((EntityPetrify)par1Entity, par2, par4, par6, par8, par9);
    }
}
